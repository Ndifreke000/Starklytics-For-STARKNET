          ...
          {!isConnected ? (
            ...
            <Card className="glass border-border max-w-md mx-auto">
              <CardHeader className="text-center">
                <CardTitle className="flex items-center justify-center space-x-2 text-base sm:text-lg md:text-xl">
              ...
              <CardContent className="space-y-4">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="text-left">
                        <p className="font-medium text-sm sm:text-base">Argent X</p>
                        <p className="text-[10px] sm:text-xs text-muted-foreground">Most popular Starknet wallet</p>
                      </div>
                    </div>
                ...
                {detectedWallets.ready && (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="text-left">
                        <p className="font-medium text-sm sm:text-base">Ready</p>
                        <p className="text-[10px] sm:text-xs text-muted-foreground">Connect to Ready wallet</p>
                      </div>
                    </div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <p className="font-medium text-sm sm:text-base">Social Login</p>
                      <p className="text-[10px] sm:text-xs text-muted-foreground">Login with Google, Twitter, or Email</p>
                    </div>
                  </div>
                </Button>
            ...
            <div className="space-y-6">
              ...
              <Card className="glass border-border">
                <CardHeader>
                  <CardTitle className="text-base sm:text-lg md:text-xl">Token Balances</CardTitle>
                </CardHeader>
                <CardContent>
